...
class TestThrottleRules:
    ...
    async def test_bypass_rule_method_specific(self, backend: InMemoryBackend) -> None:
    ...
    async def test_add_rules_bypass_on_another_throttle(
        self, backend: InMemoryBackend
    ) -> None:
        """
    ...
    async def test_multiple_bypass_rules(self, backend: InMemoryBackend) -> None:
    ...
    async def test_bypass_rule_with_predicate(self, backend: InMemoryBackend) -> None:
