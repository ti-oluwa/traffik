...
class SimpleThrottleStrategy(typing.Protocol[HTTPConnectionT]):
    ...
    async def __call__(
        ...
        """
        Execute the throttling strategy for the given request.

        :param key: The unique key representing the connection/request to be throttled.
        :param rate: The throttling rate configuration to apply.
        :param backend: The throttle backend used to track and enforce throttling state.
        :param cost: The cost of the throttling operation, defaulting to 1.
        :returns: The amount of time to wait before proceeding.
        """
        ...
...
class FullThrottleStrategy(typing.Protocol[HTTPConnectionT]):
    ...
    def get_stat(
        ...
        """
        Retrieve throttling strategy statistics for the given request.

        :param key: The unique key representing the connection/request to inspect.
        :param rate: The throttling rate configuration to inspect.
        :param backend: The throttle backend used to retrieve strategy state.
        :returns: The current strategy statistics.
        """
        ...
...
class Throttle(typing.Generic[HTTPConnectionT]):
    ...
    def __init__(
        ...
        # We register a finalization weakref for when the throttle
        # is garbage-collected so its UID can be unregistered.
