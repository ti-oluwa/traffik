...
class TestHeaders:
    async def test_static_string_headers(self, backend: InMemoryBackend) -> None:
    ...
    async def test_dynamic_rate_limit_headers(self, backend: InMemoryBackend) -> None:
    ...
    async def test_headers_only_on_throttled(self, backend: InMemoryBackend) -> None:
    ...
    async def test_no_headers_returns_empty(self, backend: InMemoryBackend) -> None:
